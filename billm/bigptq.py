...
import transformers
from .autosearch import structural_guassian_distribution
import math
    ...
    def fasterquant(self,
        ...
        for blocki, col_st in enumerate(range(0, self.columns, blocksize)):
            ...
            if W.shape[1] == 16:
                ...
                lim = math.ceil(128*0.1)
            mask1, mask2, mask3 = structural_guassian_distribution(W[:, st:ed], H[st:ed, st:ed], self.salient_metric, lim)
            mask[0] = mask1
            mask[1] = mask2
            mask[2] = mask3
